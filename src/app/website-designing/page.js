      ...
      <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-bold text-white tracking-tighter mb-8 leading-[1]">
            Website{" "}
            <span className="text-red-600 font-light italic">Designing</span>
          </h1>
          <p className="text-lg md:text-2xl text-gray-200 max-w-4xl leading-relaxed font-medium mb-12 mx-auto drop-shadow-2xl italic">
            Rank mantra is one of the leading digital agency and you can hire us
            for create website design, digital marketing and website application
            development.
          </p>
      ...
      <section className="py-24 px-6 lg:px-20 bg-white border-b border-gray-50">
        <div className="max-w-6xl mx-auto text-center" data-aos="fade-up">
          <div className="space-y-8 text-gray-600 text-base md:text-lg max-w-6xl mx-auto leading-relaxed font-normal">
            <p>
              Your website is often the first point of contact potential
              customers have with your business, making it a critical tool for
              creating a strong first impression. We specialize in custom
              website design services that are tailored to meet your specific
              business needs.
            </p>
            <p>
              Our team designs websites with a user-first approach, ensuring
              easy navigation and seamless functionality across all devices. We
              focus on creating responsive, mobile-friendly designs that deliver
              an exceptional experience for visitors, whether they're browsing
              on a desktop or smartphone. With built-in SEO optimization, your
              site will be positioned to rank higher on search engines,
              attracting more organic traffic.
            </p>
            <p>
              From stunning visuals to intuitive user interfaces, our goal is to
              ensure your website not only looks amazing but also drives
              results. Whether you need a simple landing page or a fully
              functional e-commerce site, we're here to bring your vision to
              life and help your business thrive online. Let us create a website
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="lg:w-1/2" data-aos="fade-left">
            ...
            <div className="space-y-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <p>
                Clear, intuitive menus and search options make it easy for users
                to find what they need.
              </p>
              <p>
                Your website will adapt seamlessly to all devices—smartphones,
                tablets, and desktops. Fast-loading pages to retain visitors and
                improve overall performance.
              </p>
              <p>
                We ensure your site is accessible to all, including those with
                disabilities, using screen readers, and high-contrast text.
              </p>
              <div className="pt-8">
                <a href="/contact-us">
      ...
      <section className="py-24 px-6 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 md:gap-24">
          <div className="lg:w-1/2" data-aos="fade-right">
            ...
            <div className="space-y-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <p>
                A cohesive design with consistent colors, fonts, and elements
                across the site.
              </p>
              <p>
                Important elements like headlines and calls-to-action (CTAs)
                will grab attention.
              </p>
              <p>
                Proper spacing between elements to prevent clutter and enhance
                readability.
              </p>
              <div className="pt-8">
                <a href="/contact-us">
      ...
      <section className="py-24 px-6 lg:px-20 bg-gray-50/50">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="lg:w-1/2" data-aos="fade-left">
            ...
            <div className="space-y-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <p>
                Protect your users' data with secure Socket Layer encryption,
                building trust. Regular backups ensure your data is safe.
              </p>
              <p>
                We implement measures to protect against hacking and other
                vulnerabilities.
              </p>
              <p>
                We lead drag and drop website builders and make best use of
      ...
      <section className="py-24 px-6 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-16 md:gap-24">
          <div className="lg:w-1/2" data-aos="fade-right">
            ...
            <div className="space-y-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <p>
                Tools like Google Analytics help monitor performance and improve
                your website.
              </p>
              <p>
                We test different page versions to ensure the best user
      ...
      <section className="py-24 px-6 lg:px-20 bg-gray-50/50">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="lg:w-1/2" data-aos="fade-left">
            ...
            <div className="space-y-6 text-gray-500 text-base md:text-lg leading-relaxed font-normal">
              <p>
                Keep your website’s content, software, and plugins up-to-date.
              </p>
              <p>
                We constantly monitor for issues, ensuring a smooth and
                error-free experience for your visitors.
              </p>
              <p>
                We continuously monitor and improve your website’s performance
                to ensure fast loading times, seamless user experiences, and
                high efficiency, even as traffic grows.
              </p>
              <div className="pt-8">
                <a href="/contact-us">
                  <button className="border-b-2 border-red-600 text-gray-900 font-semibold py-2 text-xs tracking-widest hover:text-red-600 transition-all uppercase">
